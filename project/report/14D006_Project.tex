...
At each state, the team can choose from one of 4 play options (actions) $u \in U$ with $U=\{R, P, U, K\}$. Each play is described using probability distributions, to model the yards gained. For this section we use the models set out in Bertsekas and Patek's article:
\begin{itemize}
...
\item missed field-goal, punt, fumble, interception (reward: 0.0)
